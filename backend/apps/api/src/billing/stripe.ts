...
export function getBillingPlanByLookupKey(lookupKey: string | null | undefined): BillingPlan | undefined {
...
export async function ensureStripePrice(stripe: Stripe, plan: BillingPlan): Promise<Stripe.Price> {
...
export function publicPlan(plan: BillingPlan) {
  return {
    id: plan.id,
    name: plan.name,
