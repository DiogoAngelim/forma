...
describe('analysis engine', () => {
  ...
  it('creates executable suggestions', () => {
      ...
      assets: [
        {
          ...
          mime: 'text/css',
          content:
            '.a{font-size:1px;color:#000}.b{font-size:2px;color:#111}.c{font-size:3px;color:#222}.d{font-size:4px;color:#333}.e{font-size:5px;color:#444}.f{font-size:6px;color:#555}.g{font-size:7px;color:#666}.h{color:#777}.i{color:#888}.j{color:#999}'
        }
      ]
    });
    ...
    expect(
      generateDeterministicSuggestions(output.projectId, {
        reusableBlocks: [],
        layoutBlocks: [],
        sectionBlocks: [],
        textBlocks: [],
